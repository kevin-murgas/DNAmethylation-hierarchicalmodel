...
pDB <- genes_dbs %>% mutate(group = factor(group, levels = c("all genes", "AGO", "COSMIC", "DEPMAP"))) %>%
  ...
  scale_x_continuous(limits=c(-5,7), breaks = c(-4, -2,0, 2, 4, 6)) + theme_classic() + ylab("Database") + xlab("Gene Conservation Score") + geom_vline(xintercept=0, color="black", alpha=0.2) + theme(aspect.ratio=60/156.3,legend.position = "none")
...
\newpage
\subsection{Oncogenes vs Tumor suppressors}
Based on list of top 20 genes mutated in CRC, manually labelled as oncogene or tumor-suppressor:
...
```{r Onco_vs_TSG, echo=FALSE, warning=FALSE, message=FALSE, fig.width=7, fig.height=2, comment=NA, fig.fullwidth=TRUE, dev = "png"}
...
cat("\nOncogenes:")
plotGeneScore("KRAS",0.25)
plotGeneScore("MYC",0.21)
plotGeneScore("BRAF",0.5)
plotGeneScore("EGFR",0.5)
plotGeneScore("CDK8",0.5)
plotGeneScore("PIK3CA",0.5)
plotGeneScore("NRAS",0.5)
plotGeneScore("GNAS",0.5)
plotGeneScore("SRC",0.5)
plotGeneScore("CTNNB1",0.5)

cat("\nTumor Suppressors:")
plotGeneScore("TP53",0.25)
plotGeneScore("APC",0.21)
plotGeneScore("KLF4",0.5)
plotGeneScore("FBXW7",0.5)
plotGeneScore("LRP1B",0.5)
plotGeneScore("PTEN",0.5)
plotGeneScore("FAT4",0.5)
plotGeneScore("ARID1A",0.5)
plotGeneScore("AMER1",0.5)
plotGeneScore("SMAD4",0.5)
