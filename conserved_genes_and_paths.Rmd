...
<!-- enrichedGenes <- permed_data %>% filter(score_median_v3 > 0.95) %>% -->
<!--   select(UCSC_RefGene_Name, score_median, score_median_v3, n) %>% -->
...
<!--   show_rownames = FALSE, -->
<!--   show_colnames = TRUE, -->
<!--   main = sprintf("Top %i Genes: Tumor PWD", ngene) -->
<!-- ) -->

<!-- df2 = df1 -->
<!-- for (ipat in 1:npat) { -->
<!--   df2[,ipat] = df1[,ipat] > quantile(df1[,ipat],0.5) -->
<!-- } -->
<!-- cat("  \n\\newline  \nMethod 1 - Lowest 50% PWD Genes within each patient") -->
<!-- pheatmap( -->
<!--   mat=df2, -->
<!--   cluster_cols = mat_cluster_cols, -->
<!--   cluster_rows = mat_cluster_rows, -->
<!--   show_rownames = FALSE, -->
<!--   show_colnames = TRUE, -->
<!--   main = sprintf("Top %i Genes: Lowest 50 percentile Tumor PWD per patient", ngene) -->
<!-- ) -->
